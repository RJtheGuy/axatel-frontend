export interface CarouselOptionsWithStop {
    container: HTMLElement
    track: HTMLElement
    speed?: number
}

export interface CarouselControllerWithStop {
    destroy(): void
    pause(): void
    resume(): void
    updateWidth(): void // Esponiamo questo metodo per resettare la larghezza se i dati cambiano
}

export function useCarouselWithStop({
    container,
    track,
    speed = 1
}: CarouselOptionsWithStop): CarouselControllerWithStop {
